...
package com.acme.flotte.config.dev;

import org.springframework.context.annotation.Profile;
import static com.acme.flotte.config.dev.DevConfig.DEV;
...
public class DevConfig implements com.acme.flotte.config.dev.LogRequestHeaders, K8s {
    /**
